...
function build(programInfo) {
  ...
  const abellFiles = getAbellFiles(programInfo.abellConfigs.sourcePath, programInfo.templateExtension);
  console.log(programInfo.abellConfigs)
  console.log(abellFiles)
