...
Abell was started in April 2020 by [Saurabh](https://x.com/saurabhdawaree). It was primarily inspired from Jekyll, Hugo, and Hexo but with a template engine that new JavaScript developers would find simpler (Jekyll and Hugo were using Ruby and GO and Hexo was using ejs but ejs had its own learing curve).
